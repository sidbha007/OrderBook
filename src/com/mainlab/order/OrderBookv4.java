...
public class OrderBookv4 {
    ...
    private static OrderBookv4 uniqueInstance = new OrderBookv4();


    private void initializeAll(){
        bidMarketRate = new ConcurrentHashMap<String, ConcurrentNavigableMap<Double, BlockingQueue<Order>>>(); //Maintain list of Market Rates offer for Sell
        offerMarketRate= new ConcurrentHashMap<String, ConcurrentNavigableMap<Double, BlockingQueue<Order>>>(); //Maintain list of Market Rates offer for Buy
        offerOrder= new ConcurrentHashMap<String, ConcurrentNavigableMap<Double, BlockingQueue<Order>>>(); //Maintain list of Orders offer for Sell
        bidOrder= new ConcurrentHashMap<String, ConcurrentNavigableMap<Double, BlockingQueue<Order>>>(); //Maintain list of Orders offer for Buy

        bidMarketRateLock = new ConcurrentHashMap<String, Lock>(); //Maintain list of Market Rates offer for Sell
        offerMarketRateLock = new ConcurrentHashMap<String, Lock>();
        offerOrderLock = new ConcurrentHashMap<String, Lock>();
        bidOrderLock = new ConcurrentHashMap<String, Lock>();
    ...
    public static OrderBookv4 getInstance(){
    ...
    public static void main(String params[]){
        ...
        OrderBookv4 orderBook = OrderBookv4.getInstance();
